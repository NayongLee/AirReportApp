...
//    private Handler mHandler;
    ...
    private static final int STATE_LISTEN = 1; // now listening for incoming connections  연결을 기다리는 중입니다.
    private static final int STATE_CONNECTING = 2; // now initiating an outgoing connection 이제 곧 연결을 시작합니다.
