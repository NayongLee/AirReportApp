...
public class LocationTrans {
    ...
    public static LocationPoint convert(int srctype, int dsttype, LocationPoint in_pt) {
        LocationPoint tmpPt = new LocationPoint();
        LocationPoint out_pt = new LocationPoint();
    ...
    public static void geo2tm(int dsttype, LocationPoint in_pt, LocationPoint out_pt) {
        double x, y;
    ...
    public static void tm2geo(int srctype, LocationPoint in_pt, LocationPoint out_pt) {
        LocationPoint tmpPt = new LocationPoint(in_pt.getX(), in_pt.getY());
        int max_iter = 6;
    ...
    public static double getDistancebyGeo(LocationPoint pt1, LocationPoint pt2) {
    ...
    public static double getDistancebyKatec(LocationPoint pt1, LocationPoint pt2) {
    ...
    public static double getDistancebyTm(LocationPoint pt1, LocationPoint pt2) {
	...
	*/
    ...
    private static void transform(int srctype, int dsttype, LocationPoint point) {
        if (srctype == dsttype)
            return;
    ...
    private static boolean geodetic_to_geocentric (int type, LocationPoint p) {
     ...
     */
    private static void geocentric_to_geodetic (int type, LocationPoint p) {
    ...
    private static void geocentric_to_wgs84(LocationPoint p) {
    ...
    private static void geocentric_from_wgs84(LocationPoint p) {
